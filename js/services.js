  ...
  .service(
    ...
    [
      ...
      function($q, $http) {
        ...
        var urlBase =
          "http://carparkrecognitionsystemapi.azurewebsites.net/cpmAPI/api/";
        ...
        this.adminLogin = function(admin) {
           ...
           */
          $http
            .post(urlBase + data.action, adminJSON, { cache: true }) // notice the dot to start the chain to success()
        ...
        this.guestLogin = function(guest) {
           ...
           */
          $http
            .post(urlBase + data.action, guestJSON, { cache: true }) // notice the dot to start the chain to success()
            .success(function(response) {
              defer.resolve({
                data: response // create data property with value from response
              });
